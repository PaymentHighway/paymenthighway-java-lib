...
**_Note:_**
Version 1.10 now always uses TLS 1.2. This fixes problems with Java 7 when older versions of TLS are no longer supported by the server. Custom HTTP client in PaymentAPI is now a constructor parameter and the setter is deprecated.
