...
public class SecureSigner {
	...
	private static String SignatureScheme = "SPH1";
     ...
     * @param sphKeyValues
     * @param body
     * @return String eg: "SPH1 testKey 51dcbaf5a9323daed24c0cdc5bb5d344f321aa84435b64e5da3d8f6c49370532"
     */
    ...
    private String sign(String method, String uri, List<NameValuePair> keyValues, String body)  {
        String stringToSign = String.format("%s\n%s\n%s\n%s",
            method,
            uri,
            concatenateKeyValues(keyValues),
            body.trim());
    ...
    private String concatenateKeyValues(List<NameValuePair> keyValues) {
        ...
        String result = keyValuesString.substring(0, keyValuesString.length() - 1);
