...
public class FormBuilder {
	...
	public FormContainer generateAddCardParameters() {
		...
		nameValuePairs.add(new BasicNameValuePair(SPH_REQUEST_ID,
	 ...
	 * @return FormContainer
	 */
	public FormContainer generatePaymentParameters(String amount,
		...
		return new FormContainer(this.method, this.baseUrl,
				this.payWithCardUri, nameValuePairs);
	}
	 ...
	 * @return FormContainer
	 */
	public FormContainer generateAddCardAndPaymentParameters(String amount,
			String currency, String orderId, String description) {
	...
	private String createSignature(String uri,
		...
		nameValuePairs = PaymentHighwayUtility
				.parseSphParameters(nameValuePairs);
